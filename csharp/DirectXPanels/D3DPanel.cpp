...
{
    m_currentCursor = ref new CoreCursor(CoreCursorType::Custom, 101);
    ...
    auto inputWorkHandler = ref new WorkItemHandler([this](IAsyncAction ^) {
        // The CoreIndependentInputSource will raise pointer events for the specified device types on whichever thread it's created on.
        // Note: This class is a SwapChainPanel!
        m_coreInput = this->CreateCoreIndependentInputSource(
    ...
    m_inputLoopWorker = ThreadPool::RunAsync(inputWorkHandler, WorkItemPriority::High, WorkItemOptions::TimeSliced);
