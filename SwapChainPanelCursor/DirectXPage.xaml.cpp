	...
	m_coreInput(nullptr)
{
    ...
    m_currentCursor = ref new CoreCursor(CoreCursorType::Hand, 0);
    window->PointerCursor = m_currentCursor;
	...
	m_main = std::unique_ptr<SwapChainPanelCursorMain>(new SwapChainPanelCursorMain(m_deviceResources));
...
void SwapChainPanelCursor::DirectXPage::Button_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
